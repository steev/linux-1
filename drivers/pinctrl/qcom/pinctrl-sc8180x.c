...
static const struct msm_pingroup sc8180x_groups[] = {
	...
	[4] = PINGROUP(4, WEST, qup6, rgmii_txd1, _, phase_flag3, _, _, _, _, _),
	[5] = PINGROUP(5, WEST, qup6, rgmii_txd2, _, phase_flag2, _, _, _, _, _),
	[6] = PINGROUP(6, WEST, qup6, rgmii_txd3, qup_l6, _, phase_flag1, _, _, _, _),
	[7] = PINGROUP(7, WEST, qup6, debug_hot, rgmii_mdc, qup_l5, _, phase_flag0, _, _, _),
	...
	[13] = PINGROUP(13, EAST, cam_mclk, qdss_gpio0, _, _, _, _, _, _, _),
	[14] = PINGROUP(14, EAST, cam_mclk, qdss_gpio1, _, _, _, _, _, _, _),
	[15] = PINGROUP(15, EAST, cam_mclk, qdss_gpio2, _, _, _, _, _, _, _),
	[16] = PINGROUP(16, EAST, cam_mclk, qdss_gpio3, _, _, _, _, _, _, _),
	[17] = PINGROUP(17, EAST, cci_i2c, qdss_gpio4, _, _, _, _, _, _, _),
	[18] = PINGROUP(18, EAST, cci_i2c, qdss_gpio5, _, _, _, _, _, _, _),
	[19] = PINGROUP(19, EAST, cci_i2c, qdss_gpio6, _, _, _, _, _, _, _),
	[20] = PINGROUP(20, EAST, cci_i2c, qdss_gpio7, _, _, _, _, _, _, _),
	...
	[25] = PINGROUP(25, EAST, cam_mclk, cci_async, qup18, qdss_gpio11, _, _, _, _, _),
	...
	[33] = PINGROUP(33, EAST, cci_i2c, qup_l5, _, phase_flag23, _, _, _, _, _),
	[34] = PINGROUP(34, EAST, cci_i2c, qup_l6, dbg_out, atest_usb22, _, _, _, _, _),
	...
	[39] = PINGROUP(39, EAST, qup9, cci_i2c, qdss_gpio6, _, _, _, _, _, _),
	[40] = PINGROUP(40, EAST, qup9, cci_i2c, qdss_gpio7, _, _, _, _, _, _),
	[41] = PINGROUP(41, EAST, qup9, cci_i2c, qdss_gpio14, _, _, _, _, _, _),
	[42] = PINGROUP(42, EAST, qup9, cci_i2c, qdss_gpio15, _, _, _, _, _, _),
	...
	[53] = PINGROUP(53, WEST, qup4, _, phase_flag29, _, _, _, _, _, _),
	[54] = PINGROUP(54, WEST, qup4, _, _, phase_flag28, _, _, _, _, _),
	[55] = PINGROUP(55, WEST, qup17, qspi1_cs, _, _, _, _, _, _, _),
	[56] = PINGROUP(56, WEST, qup17, qspi13, _, _, _, _, _, _, _),
	[57] = PINGROUP(57, WEST, qup17, qspi12, _, _, _, _, _, _, _),
	[58] = PINGROUP(58, WEST, usb1_phy, qup17, _, _, _, _, _, _, _),
	[59] = PINGROUP(59, WEST, rgmii_mdio, qup_l4, _, _, _, _, _, _, _),
	[60] = PINGROUP(60, EAST, gps, nav_pps, nav_pps, qup_l4, mdp_vsync, atest_usb1, ddr_pxi0, _, _),
	[61] = PINGROUP(61, EAST, qlink, _, _, _, _, _, _, _, _),
	[62] = PINGROUP(62, EAST, qlink, atest_tsens2, atest_usb13, ddr_pxi0, vsense_trigger, _, _, _, _),
	[63] = PINGROUP(63, EAST, wmss_reset, _, atest_usb12, ddr_pxi1, wlan1_adc1, _, _, _, _),
	[64] = PINGROUP(64, EAST, GRFC8, _, atest_usb11, ddr_pxi1, wlan1_adc0, _, _, _, _),
	[65] = PINGROUP(65, EAST, GRFC9, atest_usb10, ddr_pxi2, wlan2_adc1, _, _, _, _, _),
	[66] = PINGROUP(66, EAST, GRFC10, _, _, _, _, _, _, _, _),
	[67] = PINGROUP(67, EAST, GRFC11, _, _, _, _, _, _, _, _),
	[68] = PINGROUP(68, EAST, GRFC12, pa_indicator, atest_usb3, ddr_pxi2, wlan2_adc0, _, _, _, _),
	[69] = PINGROUP(69, EAST, mss_lte, _, _, _, _, _, _, _, _),
	[70] = PINGROUP(70, EAST, mss_lte, _, _, _, _, _, _, _, _),
	[71] = PINGROUP(71, EAST, _, GRFC0, atest_usb33, ddr_pxi3, _, _, _, _, _),
	[72] = PINGROUP(72, EAST, _, GRFC1, atest_usb32, ddr_pxi3, _, _, _, _, _),
	[73] = PINGROUP(73, EAST, _, GRFC2, atest_usb31, ddr_pxi4, _, _, _, _, _),
	[74] = PINGROUP(74, EAST, _, GRFC3, tgu_ch4, atest_usb30, ddr_pxi4, _, _, _, _),
	[75] = PINGROUP(75, EAST, _, GRFC4, tgu_ch7, atest_usb4, ddr_pxi5, _, _, _, _),
	[76] = PINGROUP(76, EAST, _, GRFC5, gps, nav_pps, nav_pps, tgu_ch6, atest_usb43, ddr_pxi5, _),
	[77] = PINGROUP(77, EAST, _, GRFC6, gps, nav_pps, nav_pps, tgu_ch5, atest_usb42, ddr_pxi6, _),
	[78] = PINGROUP(78, EAST, _, GRFC7, _, atest_usb41, ddr_pxi6, _, _, _, _),
	[79] = PINGROUP(79, EAST, _, GRFC13, _, _, _, _, _, _, _),
	[80] = PINGROUP(80, EAST, _, GRFC14, _, _, _, _, _, _, _),
	[81] = PINGROUP(81, EAST, _, GRFC15, gps, nav_pps, nav_pps, qdss_cti, _, emac_pps, _),
	[82] = PINGROUP(82, EAST, _, GRFC16, gps, nav_pps, nav_pps, mdp_vsync, qdss_cti, _, _),
	...
	[88] = PINGROUP(88, NORTH, tsif1_clk, qup8, qspi0_cs, tgu_ch3, atest_usb40, ddr_pxi7, _, _, _),
	[89] = PINGROUP(89, NORTH, tsif1_en, qup8, qspi00, mdp_vsync0, mdp_vsync1, mdp_vsync2, mdp_vsync3, mdp_vsync4, mdp_vsync5),
	[90] = PINGROUP(90, NORTH, tsif1_data, qup8, qspi01, sdc4_cmd, tgu_ch1, qdss_cti, atest_usb0, ddr_pxi7, _),
	[91] = PINGROUP(91, NORTH, tsif1_sync, qup8, qspi02, sdc43, vfr_1, tgu_ch2, atest_usb03, _, _),
	[92] = PINGROUP(92, NORTH, tsif2_clk, qup11, qspi0_clk, sdc4_clk, qdss_gpio13, atest_usb02, _, _, _),
	[93] = PINGROUP(93, NORTH, tsif2_en, qup11, qspi03, sdc42, atest_tsens, atest_usb01, _, _, _),
	[94] = PINGROUP(94, NORTH, tsif2_data, qup11, qspi0_cs, sdc41, _, atest_usb00, _, _, _),
	[95] = PINGROUP(95, EAST, tsif2_sync, qup11, sdc40, qup_l4, atest_usb2, _, _, _, _),
	[96] = PINGROUP(96, WEST, tsif2_error, qup_l5, _, _, _, _, _, _, _),
	[97] = PINGROUP(97, WEST, sd_write, tsif1_error, qup_l6, _, _, _, _, _, _),
	...
	[102] = PINGROUP(102, SOUTH, pci_e1, _, phase_flag4, atest_usb23, _, _, _, _, _),
	...
	[114] = PINGROUP(114, WEST, qup1, rgmii_txc, _, qdss_gpio0, _, _, _, _, _),
	[115] = PINGROUP(115, WEST, qup1, rgmii_rxc, adsp_ext, _, qdss_gpio1, _, _, _, _),
	[116] = PINGROUP(116, WEST, qup1, rgmii_rx, _, qdss_gpio2, _, _, _, _, _),
	[117] = PINGROUP(117, WEST, qup1, rgmii_rxd0, _, qdss_gpio3, _, _, _, _, _),
	[118] = PINGROUP(118, WEST, rgmii_rxd1, _, qdss_gpio4, _, _, _, _, _, _),
	[119] = PINGROUP(119, WEST, qup5, rgmii_rxd2, _, qdss_gpio5, _, _, _, _, _),
	[120] = PINGROUP(120, WEST, qup5, rgmii_rxd3, _, phase_flag17, qdss_gpio, _, _, _, _),
	[121] = PINGROUP(121, WEST, qup5, rgmii_tx, _, phase_flag16, qdss_gpio, atest_usb21, _, _, _),
	[122] = PINGROUP(122, WEST, qup5, rgmii_txd0, _, phase_flag15, atest_usb20, _, _, _, _),
	[123] = PINGROUP(123, SOUTH, usb2phy_ac, _, phase_flag14, _, _, _, _, _, _),
	[124] = PINGROUP(124, SOUTH, emac_phy, _, _, _, _, _, _, _, _),
	[125] = PINGROUP(125, WEST, hs3_mi2s, _, phase_flag22, _, _, _, _, _, _),
	...
	[130] = PINGROUP(130, WEST, sec_mi2s, pll_bist, _, qdss_gpio12, _, _, _, _, _),
	[131] = PINGROUP(131, WEST, ter_mi2s, gcc_gp1, _, _, _, _, _, _, _),
	[132] = PINGROUP(132, WEST, ter_mi2s, _, qdss_gpio11, _, _, _, _, _, _),
	[133] = PINGROUP(133, WEST, ter_mi2s, _, qdss_gpio8, atest_char, _, _, _, _, _),
	[134] = PINGROUP(134, WEST, ter_mi2s, _, qdss_gpio9, atest_char0, _, _, _, _, _),
	[135] = PINGROUP(135, WEST, ter_mi2s, _, qdss_gpio10, atest_char1, _, _, _, _, _),
	...
	[140] = PINGROUP(140, WEST, qua_mi2s, gcc_gp5, _, atest_char2, _, _, _, _, _),
	[141] = PINGROUP(141, WEST, qua_mi2s, qdss_cti, _, _, _, _, _, _, _),
	[142] = PINGROUP(142, WEST, qua_mi2s, _, _, qdss_cti, atest_char3, _, _, _, _),
	...
	[148] = PINGROUP(148, WEST, spkr_i2s, audio_ref, _, phase_flag21, _, _, _, _, _),
	[149] = PINGROUP(149, WEST, lpass_slimbus, spkr_i2s, _, phase_flag20, _, _, _, _, _),
	[150] = PINGROUP(150, WEST, lpass_slimbus, spkr_i2s, _, phase_flag19, tsense_pwm1, tsense_pwm2, _, _, _),
	[151] = PINGROUP(151, WEST, lpass_slimbus, spkr_i2s, _, phase_flag18, _, _, _, _, _),
	[152] = PINGROUP(152, WEST, lpass_slimbus, spkr_i2s, _, phase_flag13, _, _, _, _, _),
	[153] = PINGROUP(153, WEST, btfm_slimbus, _, _, _, _, _, _, _, _),
	[154] = PINGROUP(154, WEST, btfm_slimbus, _, _, _, _, _, _, _, _),
	[155] = PINGROUP(155, WEST, hs1_mi2s, _, phase_flag12, _, _, _, _, _, _),
	[156] = PINGROUP(156, WEST, hs1_mi2s, _, phase_flag11, _, _, _, _, _, _),
	[157] = PINGROUP(157, WEST, hs1_mi2s, _, phase_flag10, _, _, _, _, _, _),
	[158] = PINGROUP(158, WEST, hs1_mi2s, _, phase_flag9, _, _, _, _, _, _),
	[159] = PINGROUP(159, WEST, hs1_mi2s, cri_trng0, _, phase_flag8, _, _, _, _, _),
	[160] = PINGROUP(160, WEST, hs2_mi2s, cri_trng1, _, phase_flag7, _, _, _, _, _),
	[161] = PINGROUP(161, WEST, hs2_mi2s, qspi11, cri_trng, _, phase_flag24, _, _, _, _),
	[162] = PINGROUP(162, WEST, hs2_mi2s, qspi10, sp_cmu, _, phase_flag6, _, _, _, _),
	[163] = PINGROUP(163, WEST, hs2_mi2s, qspi1_clk, prng_rosc, _, phase_flag5, _, _, _, _),
	[164] = PINGROUP(164, WEST, hs2_mi2s, qspi1_cs, _, phase_flag31, _, _, _, _, _),
	[165] = PINGROUP(165, WEST, hs3_mi2s, _, phase_flag30, _, _, _, _, _, _),
	[166] = PINGROUP(166, WEST, hs3_mi2s, _, phase_flag27, _, _, _, _, _, _),
	[167] = PINGROUP(167, WEST, hs3_mi2s, _, phase_flag26, _, _, _, _, _, _),
	[168] = PINGROUP(168, WEST, hs3_mi2s, _, phase_flag25, _, _, _, _, _, _),
	...
	[177] = PINGROUP(177, SOUTH1, _, _, _, _, _, _, _, _, _),
	[178] = PINGROUP(178, SOUTH1, pci_e3, cci_timer4, _, _, _, _, _, _, _),
	[179] = PINGROUP(179, SOUTH1, pci_e3, cam_mclk, _, _, _, _, _, _, _),
	[180] = PINGROUP(180, SOUTH1, cam_mclk, _, _, _, _, _, _, _, _),
	[181] = PINGROUP(181, SOUTH1, qup19, cam_mclk, _, _, _, _, _, _, _),
	[182] = PINGROUP(182, SOUTH1, qup19, cci_timer5, gcc_gp4, _, _, _, _, _, _),
	[183] = PINGROUP(183, SOUTH1, qup19, cci_timer6, gcc_gp5, _, _, _, _, _, _),
	[184] = PINGROUP(184, SOUTH1, qup19, cci_timer7, _, _, _, _, _, _, _),
	[185] = PINGROUP(185, SOUTH1, cci_timer8, cci_async, _, _, _, _, _, _, _),
	[186] = PINGROUP(186, SOUTH1, cci_timer9, cci_async, _, _, _, _, _, _, _),
	[187] = PINGROUP(187, SOUTH1, _, _, _, _, _, _, _, _, _),
	[188] = PINGROUP(188, SOUTH1, _, _, _, _, _, _, _, _, _),
	[189] = PINGROUP(189, SOUTH1, dp_hot, _, _, _, _, _, _, _, _),
	[190] = UFS_RESET(ufs_reset, 0xdb6004),
	[191] = SDC_QDSD_PINGROUP(sdc2_clk, 0x9b2000, 14, 6),
	[192] = SDC_QDSD_PINGROUP(sdc2_cmd, 0x9b2000, 11, 3),
	[193] = SDC_QDSD_PINGROUP(sdc2_data, 0x9b2000, 9, 0),
};
